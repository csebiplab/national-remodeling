...
const ourServices = [
  ...
  },
  {
    ...
    desc: `Revitalize your home's sanctuary with our expert bathroom renovation services. From modern upgrades to timeless classics, we specialize in transforming your bathroom into a space that reflects your style and enhances functionality. Our team of skilled professionals ensures meticulous attention.`,
  }
];
    ...
    <div className="our__service__box">
      <div className="container">
        <div className=" !px-[35px] md:px-0 common__padding__top">
          ...
          <p className="mt-4 lg:mb-[25px] mb-[15px] text-[28px] md:text-3xl lg:text-4xl text-dark leading-normal md:text-start text-center font-medium">Our General Contractors Services <span className="text-primary">in Toronto</span></p>
